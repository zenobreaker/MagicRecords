...
public class MStatController : MonoBehaviour
{
    ...
    // 몬스터 인식 범위를 반환하는 함수
    float GetMonsterSearchDistance(MonsterType _type)
    {
        switch (_type)
        {
            // 일반 몬스터 일 때 
    ...
    public void SetStatus(ref Status p_Status, MonsterType p_MonsterType)
    {
        switch (p_MonsterType)
        {
            case MonsterType.NORMAL:
                rankValue = 1f;
    ...
    public void SetRankTypeStatus(MonsterType p_MonsterType)
    {
