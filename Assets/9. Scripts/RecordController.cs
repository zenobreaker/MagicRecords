...
public class RewardCard
{
    ...
    public RewardCard(RecordType recordType, Sprite rewardSprite, string name, float value)
    {
...
public class RecordController : MonoBehaviour
{
    ...
    public void SetRecordRewardList(int count)
    {
        ...
        foreach(var record in list)
        {
            ...
            // 카드에 데이터 넣어준다. 
            RewardCard rewardCard = new RewardCard(RecordType.NORMAL, sprite, record.name, 0.0f);
    ...
    public void SetRewardCard()
    {
        ...
        for (int i = 0; i < rewardCards.Count; i++)
        {
            ...
            switch ((RecordType)r_RewardType)
            {
    ...
    public void ConfirmReward()
    {
        ...
        if(reward.recordType == RecordType.NORMAL)
        { 
            if(RecordManager.instance != null)
            {
